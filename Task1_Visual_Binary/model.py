"""Model: MobileNetV2 + Temporal Attention (Efficient, Less Overfitting)"""
import torch
...
class VisualBinaryClassifier(nn.Module):
    """Simplified Video Classifier - Less Overfitting"""
    def __init__(self, num_classes=2, hidden_size=256, lstm_layers=2, dropout=0.5):
        super(VisualBinaryClassifier, self).__init__()
